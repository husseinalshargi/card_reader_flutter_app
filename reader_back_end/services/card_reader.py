...
class CardReader:
    ...
    def read_card(self, img_bytes: bytes, is_binarized: bool, is_extracted: bool, languages_list: list[str]) -> dict[str, str]:
        ...
        processed_image = self.image_pre_processor.process_image(img, is_binarized, is_extracted)
